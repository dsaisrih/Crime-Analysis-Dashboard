...
![Platform](https://img.shields.io/badge/Platform-Web-blue?style=flat-square&logo=googlechrome)
![Python](https://img.shields.io/badge/Python-3.10+-yellow?style=flat-square&logo=python)
![FastAPI](https://img.shields.io/badge/Backend-FastAPI-009688?style=flat-square&logo=fastapi)
![Chart.js](https://img.shields.io/badge/Charts-Chart.js_4.4-FF6384?style=flat-square&logo=chartdotjs)
![Claude AI](https://img.shields.io/badge/AI-Claude_Sonnet_4-orange?style=flat-square&logo=anthropic)
...
- 🏙️ District-level comparison bar chart (resolved vs open cases)
- 🤖 Auto-generated AI insight cards

### 🗂️ Incidents
- 🔎 Searchable and sortable incident table (50+ records)
- 🏷️ Fields: Incident ID, Date, Crime Type, Location, Severity, Status, Assigned Officer
...
- 🗺️ Geographic risk zone dot-map with density visualization
- 🎯 Per-crime-type prediction cards with confidence scores
- 🛡️ Prevention strategy generator via AI
...
| ⚙️ Runtime | Vanilla JavaScript (no build step required) |
| 🐍 Backend | Python 3.10+, FastAPI, Uvicorn |
| 🧠 ML | scikit-learn, Facebook Prophet |
| 🗺️ Geo | GeoPandas, DBSCAN clustering |
...
- ⚙️ Feature engineering: day of week, hour, district, weather proxy, seasonality
- 📊 Returns point predictions + 80% and 95% confidence intervals

### 🗺️ Hotspot Detection (`hotspot_detector.py`)
...
- 🎛️ Supports configurable epsilon and min-samples for different city densities
...
### 🖥️ Option 2 — Full stack with Python backend
...
- 🏙️ **District** — North, South, East, West, Central Zone (or all)
- 🏷️ **Crime Type** — Theft, Assault, Burglary, Fraud, Drug, Vandalism (multi-select)
- ⚠️ **Severity** — High, Medium, Low (multi-select)
...
- [ ] 🗺️ Live map integration with Leaflet.js and OpenStreetMap
